begin
execute immediate 'CREATE TABLE "tbl_order" (
...
execute immediate 'CREATE TABLE "tbl_order_item" (
...
execute immediate 'CREATE TABLE "exam_company"(
...
execute immediate 'CREATE VIEW "tbl_order_view" as
select
        o."id",
		o."order_num",
		o."exam_date",
...
;
execute immediate 'CREATE TABLE "item_view" (
...
execute immediate 'CREATE TABLE "meal_view"(
	"meal_name"	VARCHAR2(255) UNIQUE NOT NULL,
	"meal_code"	VARCHAR2(255) UNIQUE NOT NULL
)'
;

execute immediate 'CREATE TABLE "dictionary_view"(
...
execute immediate 'CREATE TABLE "accomplish_order"(
...
execute immediate 'CREATE TABLE "accomplish_order_item"(
	"order_num" VARCHAR2(100) UNIQUE NULL,
	"item_code" VARCHAR2(50) NOT NULL,
...
execute immediate 'CREATE TABLE "report_state"(
...
execute immediate 'CREATE TABLE "report_baseinfo"(
	"report_id" VARCHAR2(100) NOT NULL PRIMARY KEY,
...
execute immediate 'CREATE TABLE "report_summary"(
	"report_id" VARCHAR2(100) NOT NULL PRIMARY KEY,
...
execute immediate 'CREATE TABLE "report_department"(
	"report_id"	VARCHAR2(100) NOT NULL PRIMARY KEY,
...
execute immediate 'CREATE TABLE "report_detail"(
	"report_id"	VARCHAR2(100) NOT NULL PRIMARY KEY,
	"department_id" VARCHAR2(50) NOT NULL,
	"department" VARCHAR2(50) NOT NULL,
